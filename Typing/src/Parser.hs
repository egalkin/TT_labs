...
happyExpList = Happy_Data_Array.listArray (0,33) ([2816,576,176,0,0,45056,0,0,704,16,16,0,0,1,2816,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseExpr","Expr","Lambda","Appl","Atom","Id","IDENT","LAMBDA","POINT","LEFTP","RIGHTP","%eof"]
        bit_start = st * 14
        bit_end = (st + 1) * 14
...
action_0 (10) = happyShift action_10
...
action_2 (7) = happyGoto action_13
...
action_16 (6) = happyGoto action_9
...
happyReduction_1 (HappyAbsSyn5  happy_var_2)
	(HappyAbsSyn6  happy_var_1)
	 =  HappyAbsSyn4
		 (ApplicationTree happy_var_1 happy_var_2
	)
...
happyReduction_4 ((HappyAbsSyn4  happy_var_4) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn5
		 (LambdaTree happy_var_2 happy_var_4
	) `HappyStk` happyRest
